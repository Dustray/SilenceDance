...
import com.example.pedometer.StepService;
import com.example.pedometer.StepUtils;
...
public class PedometerActivity extends Activity {
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		...
		menu.add(0, MENU_SETTINGS, 0, R.string.settings)
				...
				.setShortcut('8', 's')
				.setIntent(new Intent(this, StepSettingsActivity.class));
