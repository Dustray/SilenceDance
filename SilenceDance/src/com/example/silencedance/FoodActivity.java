...
public class FoodActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//列表每一项点击事件
		lvFoodNew.setOnItemClickListener(new OnItemClickListener() {
			@Override
			public void onItemClick(AdapterView<?> arg0, View view, int position,
					long id) {
				NewEntity one=newList.get(position);
				Intent intent=new Intent(FoodActivity.this,NewInfoActivity.class);
	...
	// 初始化控件
	private void init() {
		lvFoodNew = (ListView) findViewById(R.id.lvFoodNew);
	}
